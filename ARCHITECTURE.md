...
| `prep_push_rep` | `prep_push_rep [id] [filepath] [SIZE_MB/SIZE_GB/COUNT val] [device <id_or_name>]` | `cmd_prep_push_rep` — full pipeline on one movie |
| `prep_push_rep_season` | `prep_push_rep_season [id] [folder] [SIZE_MB/SIZE_GB/COUNT val] [episodes <range>] [device <id_or_name>]` | `cmd_prep_push_rep_season` — sequential pipeline for a season |
...
| `push` | `push [id] [SIZE_MB/SIZE_GB/COUNT val] [chunks 1-4] [device <id_or_name>]` | `cmd_push` |
| `push_group` | `push_group [id] [SIZE_..] [episodes 1-3] [device <id_or_name>]` | `cmd_push_group` |
