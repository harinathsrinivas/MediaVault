...
def save_library(data):
    ...
    # Write files
    with open(LIBRARY_MOVIES, 'w') as f:
        json.dump(mov_data, f, indent=4)
    with open(LIBRARY_SERIES, 'w') as f:
        json.dump(tv_data, f, indent=4)
    with open(LIBRARY_ANIME, 'w') as f:
        json.dump(ani_data, f, indent=4)
...
def cmd_replace(manual_id):
    ...
    if os.path.exists(original):
        # [UPDATED] ROBUST DELETION (Retry + Force Write)
        removed = False
