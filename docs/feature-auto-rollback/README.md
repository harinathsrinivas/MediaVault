...
The live working copy the orchestrator/planner consume is `/PLAN.md` at the repo
root; the copy in this folder is the archived draft as of the pause. Re-sync the
folder copy after a re-plan.
