...
- [ ] 1. [model: opus] [effort: high] Add the shared logged-out detector to `mainfetch.py`.
  - Files: `mainfetch.py`
...
- [ ] 2. [model: opus] [effort: high] Wire the detector into `trigger_download` + `cmd_fetch_route` (IMP-C6 early-abort) and add the single-flight lock to `cmd_fetch_route`.
  - Files: `mainfetch.py`
...
- [ ] 3. [model: opus] [effort: high] Add the single-flight lock helper + state-dir constants to `mvcommon.py`.
  - Files: `mvcommon.py`
...
- [ ] 4. [model: sonnet] [effort: medium] Create `tools/notify_toast.py` — dependency-free Windows toast.
...
- [ ] 5. [model: opus] [effort: high] Create `tools/warm_profiles.py` — the keep-alive runner.
...
- [ ] 6. [model: sonnet] [effort: medium] Create the committed Task Scheduler XML.
...
- [ ] 7. [model: opus] [effort: high] Unit tests for the session detector + early-abort.
...
- [ ] 8. [model: sonnet] [effort: medium] Unit tests for `tools/warm_profiles.py`.
...
- [ ] 9. [model: sonnet] [effort: medium] Unit tests for `tools/notify_toast.py` + smoke extension.
...
- [ ] 10. [model: sonnet] [effort: medium] Update README + ARCHITECTURE.
...
- [ ] 11. [model: haiku] [effort: low] Mark IMP-C17 + IMP-C6 done and update the priority surfaces.
