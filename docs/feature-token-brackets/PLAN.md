...
- [x] **3. Artwork walk** — `_ancestor_show_folder_image` → any-provider/any-shape; docstrings at 9652/9702/9777; `resolve_artwork_path` rung-(iii) comment.
